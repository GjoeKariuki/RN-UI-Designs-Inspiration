    ...
    <View className="flex-1" style={{backgroundColor:fruit.color}}>
      <SafeAreaView>
        <View className="flex-row justify-start mx-5">
            <TouchableOpacity style={{backgroundColor:'rgba(255,255,255,0.2)'}} onPress={()=> navigation.goBack()} className="border border-gray-50 rounded-xl">
      ...
      className="bg-orange-50 flex-1 px-6 space-y-2">
        ...
        <View className="flex-row justify-between mb-3">
            ...
            <Text className="text-gray-500 font-semibold">Sold<Text className="text-gray-800 font-extrabold">239</Text></Text>
        </View>
        <StarRating 
          disabled={true}
          starSize={10}
        ...
        <View style={{height:165}}>
          <Text style={{color:themeColors.text}} className="tracking-wider py-3">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facilis saepe earum natus amet voluptates non at fuga, dignissimos laborum magnam reiciendis repellat tempora eligendi ipsa enim commodi pariatur est ut?
          </Text>
        </View>
        <View className="flex-row justify-between items-center">
          ...
          <TouchableOpacity 
            ...
            style={{backgroundColor:fruit.shadow, opacity:0.6, shadowColor:fruit.shadow, shadowRadius:25, shadowOffset:{width:0, height:15}, shadowOpacity:0.5}}
          >
